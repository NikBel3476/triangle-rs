 ...
 * @param struct mesh *m;
 * @param struct behavior *b;
 * @param struct otri *tri;             Edge at which to insert the new subsegment.
 * @param int subsegmark;                            Marker for the new subsegment.
 */
 ...
 * @param struct mesh *m;
 * @param struct behavior *b;
 * @param struct otri *flipedge;                    Handle for the triangle abc.
 */
